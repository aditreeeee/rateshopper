...
document.addEventListener('DOMContentLoaded', ()=>{
  const me = PORTAL.mount({ title:'Decision & Actions', subtitle:'Pricing recommendations and an action center to apply them.' });
  if(!me) return;
  ...
  // the app land directly on the right tab instead of always Pricing Recommendations.
